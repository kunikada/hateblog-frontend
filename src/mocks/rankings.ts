...
export const mockYearlyRankings: RankingEntry[] = [
  {
    ...
    tags: [
      { name: '技術トレンド', score: 1.0 },
      { name: '2024年', score: 0.8 },
      { name: '総まとめ', score: 0.6 },
    ],
    excerpt:
  ...
  },
  {
    ...
    tags: [
      { name: 'Docker', score: 1.0 },
      { name: 'Kubernetes', score: 0.8 },
      { name: 'DevOps', score: 0.6 },
    ],
    excerpt:
  ...
  },
  {
    ...
    tags: [
      { name: 'GraphQL', score: 1.0 },
      { name: 'API', score: 0.8 },
      { name: 'バックエンド', score: 0.6 },
    ],
    excerpt:
  ...
  },
  {
    ...
    tags: [
      { name: 'Rust', score: 1.0 },
      { name: 'システムプログラミング', score: 0.8 },
      { name: 'パフォーマンス', score: 0.6 },
    ],
  },
  {
    id: 'r7',
    ...
    tags: [
      { name: 'GitHub Actions', score: 1.0 },
      { name: 'CI/CD', score: 0.8 },
      { name: '自動化', score: 0.6 },
    ],
  },
  {
    ...
    tags: [
      { name: 'AWS', score: 1.0 },
      { name: 'Serverless', score: 0.8 },
      { name: 'Lambda', score: 0.6 },
    ],
  },
  {
    id: 'r9',
    ...
    tags: [
      { name: 'PostgreSQL', score: 1.0 },
      { name: 'MySQL', score: 0.8 },
      { name: 'データベース', score: 0.6 },
    ],
  },
  {
    id: 'r10',
    ...
    tags: [
      { name: 'セキュリティ', score: 1.0 },
      { name: 'Webアプリ', score: 0.8 },
      { name: 'ベストプラクティス', score: 0.6 },
    ],
  },
]
